...
| 文档 | 用途 |
|------|------|
| [`API.md`](API.md) | REST 响应格式与错误码契约 |
| [`ROADMAP.md`](ROADMAP.md) | **从地基到交付的逐步执行计划**（按 S0→S6 勾选） |
| [`DESIGN.md`](DESIGN.md) | 产品/架构/UI 字段/引擎规格 |
| [`UI-PLAYBOOK.md`](UI-PLAYBOOK.md) | 好看、自然、高效的体验规则 |
| [`UI-COPY.md`](UI-COPY.md) | 标准中文文案库 |
| [`UI-WIREFRAMES.md`](UI-WIREFRAMES.md) | 各页面低保真布局 |
